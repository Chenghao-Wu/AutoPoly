...
system=AutoPoly.System(out="test_poly_mole_mix_tri")
...
poly=AutoPoly.Polymerization(Name="Molecular_Mixture",System=system,Model=[naphthalene,benzene,PE],run=True)
