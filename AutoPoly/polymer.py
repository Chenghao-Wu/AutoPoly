...
class Polymer:
    ...
    def get_tacticity_for_chain(self, chain_idx: int) -> List[bool]:
        ...
        """
        if 0 <= chain_idx < len(self.tacticity_set):
            return self.tacticity_set[chain_idx]
        return []

    def get_sequenceSet(self) -> List[List[str]]:
        """
    ...
    def get_sequenceNames(self) -> List[List[str]]:
        """
    ...
    def get_chain_info(self) -> dict:
        ...
        return {
            ...
            'sequenceSet': self.sequenceSet,
            'sequenceNames': self.sequenceName,
